...
public class TestSuite extends Utility {
    ...
    String s1, expectedTest, actualText;
    ...
    public void verifyProductArrangeInAlphaBaticalOrder() {
        ...
        expectedTest = "Name: Z to A";
        actualText = getTextFromElement(By.xpath("//option[contains(text(),'Name: Z to A')]"));
        Assert.assertEquals("Text Matched", expectedTest, s1);
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        expectedTest = "Build your own computer";
        String actualResult = getTextFromElement(By.xpath("//h1[contains(text(),'Build your own computer')]"));
        Assert.assertEquals("Text Matched", expectedTest, actualResult);
        ...
        //Change the Qty to "2"
        clearTextFromElement(By.className("qty-input"));
        ...
        //Add first name
        sendTextToElement(By.id("BillingNewAddress_FirstName"), "Helly");

        //Add Last name
        sendTextToElement(By.id("BillingNewAddress_LastName"), "Seth");

        //Add email address
        sendTextToElement(By.id("BillingNewAddress_Email"), "Hellyseth1@gmail.com");
        ...
        //Add address1
        sendTextToElement(By.id("BillingNewAddress_Address1"), "Croydon");
        ...
        sendTextToElement(By.id("CardholderName"), "Helly");
